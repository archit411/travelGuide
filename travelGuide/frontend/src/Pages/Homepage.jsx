...
export default function HomePage() {
  ...
  // Hide AI welcome popup while scrolling, show again when stopped
  useEffect(() => {
    let scrollTimeout;

    const handleScroll = () => {
      // Hide popup immediately when scrolling
      if (showAIWelcome) {
      ...
      // Show popup again after scrolling stops for 2 seconds
  ...
  const places = topPlaces
    .flatMap((p) => [
      p.placeOne && {
        ...
        img: p.image_url1 || "https://images.unsplash.com/photo-1493976040374-85c8e12f0c0e?w=800",
        crowdLevel: p.placeOneCrowdLevel || "Low",
      },
      p.placeTwo && {
        name: p.placeTwo,
        desc: p.placeTwoDescription,
        img: p.image_url2 || "https://images.unsplash.com/photo-1613395877344-13d4c2ce5f47?w=800",
  ...
  return (
    <div className="homepage-modern" style={{ paddingBottom: isMobile ? "80px" : "0" }}>
